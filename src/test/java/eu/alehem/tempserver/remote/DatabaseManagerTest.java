...
public class DatabaseManagerTest {
  ...
  private final Set<Temperature> REFERENCE_TEMPERATURES =
      Stream.of(
              ...
              new Temperature("10", 2.0, Instant.ofEpochSecond(10)))
  ...
  public void testCountMeasurementsInDb() throws SQLException {
    ...
    DatabaseManager.insertTemperatures(
        Stream.of(
                new Temperature("1", 2.0, Instant.ofEpochSecond(1)),
                new Temperature("1", 2.0, Instant.ofEpochSecond(2)))
            .collect(Collectors.toSet()),
        TEST_DATABASE_URL);
  ...
  public void testDeleteTemperature() throws SQLException {
    Temperature toRemove = new Temperature("1", 2.0, Instant.ofEpochSecond(1));
